...
/* #define CONFIG_MTD_DEVICE       /1* needed for mtdparts commands *1/ */
/* #define CONFIG_FLASH_CFI_MTD */
/* #define MTDIDS_DEFAULT          "nor0=fe8000000.flash" */
/*
 * Flash layout
 */
/* #define MTDPARTS_DEFAULT        "mtdparts=fe8000000.flash:128k(pbl),59m(sda jffs2),1m(sdb jffs2),3m(netinitbak),128k(tlabshimbak),128k(fmanfwbak),128k(ubootenvbak),512k(ubootbak),128k(pblbak),43m(raw),1m(dtb),16m(kernel),3m(netinit),128k(tlabshim),128k(fmanfw),128k(ubootenv),512k(uboot)" */
...
/* Processor Daughtercard CPLD */
#define UPCPLD_BASE		0xffdf0000	/* UPCPLD registers */
#ifdef CONFIG_PHYS_64BIT
#define UPCPLD_BASE_PHYS		0xfffdf0000ull
#else
#define UPCPLD_BASE_PHYS		UPCPLD_BASE
#endif

#define CONFIG_SYS_BR1_PRELIM	(BR_PHYS_ADDR(UPCPLD_BASE_PHYS) | BR_PS_8 | BR_V)
...
/* Motherboard CPLD */
#define MBCPLD_BASE		0xffe00000	/* MBCPLD registers */
#ifdef CONFIG_PHYS_64BIT
#define MBCPLD_BASE_PHYS		0xfffe00000ull
#else
#define MBCPLD_BASE_PHYS		MBCPLD_BASE
#endif

#define CONFIG_SYS_BR2_PRELIM	(BR_PHYS_ADDR(MBCPLD_BASE_PHYS) | BR_PS_8 | BR_V)
#define CONFIG_SYS_OR2_PRELIM	0xffffeff7	/* 32KB but only 4k mapped */
...
#define CONFIG_SYS_FM1_10GEC1_PHY_ADDR	0xd
#define CONFIG_SYS_FM1_DTSEC1_RISER_PHY_ADDR	0x4
#define CONFIG_SYS_FM1_DTSEC2_RISER_PHY_ADDR	0x4
#define CONFIG_SYS_FM1_DTSEC3_RISER_PHY_ADDR	0x4
#define CONFIG_SYS_FM1_DTSEC4_RISER_PHY_ADDR	0x4
